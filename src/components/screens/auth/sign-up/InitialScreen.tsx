...
import { SignUpSteps } from "@/pages/auth/sign-up";
...
const InitialScreen: FC<InitialScreenProps> = ({
  ...
  return (
    <div>
      <PageView pageCount={4} currentPage={1} />
      <h1
        className={
          "max-[1000px]:text-center  text-24 sm:text-32 font-semibold mb-3"
        }
      >
        Qeydiyyatdan keçin
      </h1>
      ...
      >
        Şəxsi kabinetdə qeydiyyatdan keçərək xidmətləri səbətə əlavə edə,
        sifarişlərin tarixçəsinə baxa bilərsiniz və eyni zamanda da müəyyən
        edilmiş endirimlərdən yararlana bilərsiniz.
      </p>
      ...
      <p className={"text-[#6E6E6E] text-14 text-center font-medium"}>
        Mövcud hesabınız var?{" "}
        <Link href={`/auth/sign-in`} className={"text-[#1758C9]   font-bold"}>
          Daxil olun{" "}
        </Link>
      </p>
    </div>
